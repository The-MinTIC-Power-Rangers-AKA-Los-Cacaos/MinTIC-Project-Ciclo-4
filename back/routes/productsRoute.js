...
const {getProducts, newProduct, getProductById, editProduct, deleteProduct, createUpdateProductReview, getProductReviews, deleteProductReview} = require("../controllers/productsController");
